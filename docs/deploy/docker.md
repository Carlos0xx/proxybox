...
| Use | Default | On conflict |
| --- | --- | --- |
| Admin UI | TCP `8080` | Try `18080`, `28080`, `38080`, `48080`, then high random candidates. |
| VLESS template + device range | TCP `11000`, `11001-11050` | Try contiguous ranges starting from `12000/12001-12050`. |
| Hy2 template + device range | UDP `21000`, `21001-21050` | Try contiguous ranges starting from `22000/22001-22050`. |
