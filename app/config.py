...
class ServerSettings(BaseModel):
    public_host: str = ""
    # Reality / Hy2 cover domain (the SNI the handshake claims). Recorded
    # here for visibility + admin tooling; the authoritative value is baked
    # into /etc/sing-box/config.json. Empty = legacy installs that predate
    # this field (their SNI still lives in the sing-box config).
    cover_domain: str = ""
